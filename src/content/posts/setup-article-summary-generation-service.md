---
title: "自建服务：使用 AI 生成文章摘要并使用 Kokoro TTS 生成语音播报"
description: "在 HomeLab 中用自托管 one-api + Kokoro TTS 替换 TianliGPT，实现 Hexo 博客文章的 AI 摘要生成与语音播报。"
pubDate: "2025-01-18"
category: "ai"
banner: "./setup-article-summary-generation-service/cover.webp"
tags:
  - "Hexo"
  - "Homelab"
  - "效率工具与工作流"
...
其实在 [使用 Node.js 开发数字名片并集成 Chat 服务](/posts/npx-card-dev/) 这篇文章已经将本地的 LLM API 服务搭建好了, 因为 TianliGPT 的语音播报服务无法使用, 所以一直在等 [Kokoro TTS](https://huggingface.co/hexgrad/Kokoro-82M) 的中文模型, 正好今天开源了, 所以又可以开始折腾了.
...
![20250208223047_6SH1UonG.webp](./setup-article-summary-generation-service/20250208223047_6SH1UonG.webp)
...
LLM API 直接使用 [使用 Node.js 开发数字名片并集成 Chat 服务](/posts/npx-card-dev/) 这篇文章中已部署好的 one-api, 好处是不需要将厂商 Key 放在前端代码中, 可以避免一点的安全问题, 另外在 one-api 我可以随时添加 LLM 厂商服务, 且可控制指定 Key 的 Token 总量与有效期, 所以并不是太担心自己的 Token 被恶意使用, 即使第三方的 Token 被恶意消耗完, 我还可以使用本地部署 LLM 服务, 得益于 one-api 的代理功能, 简单的修改 one-api 配置即可使用, 不需要重新部署博客.
...
![20250208212138_yyglInIu.webp](./setup-article-summary-generation-service/20250208212138_yyglInIu.webp)
...
![20250208223048_VDtpJCBF.webp](./setup-article-summary-generation-service/20250208223048_VDtpJCBF.webp)
...
![20250208214224_0h3tBPgJ.webp](./setup-article-summary-generation-service/20250208214224_0h3tBPgJ.webp)

**自带 WebUI**:

![20250208220534_NqhGwId3.webp](./setup-article-summary-generation-service/20250208220534_NqhGwId3.webp)
...
![20250209003039_KL0AlEW7.webp](./setup-article-summary-generation-service/20250209003039_KL0AlEW7.webp)
