...
description: "详解 Java 方法区和运行时常量池的特征，以及 HotSpot 在不同 JDK 版本中的实现变迁。 方法区在 JDK1.2 到 JDK6 使用永久代实现，从 JDK7 开始移除永久代，JDK8 中被元空间取代。文章还通过测试代码说明了这些变迁对程序执行的影响，如 String 对象的 intern 方法在不同版本 Java 中的行为差异。"
pubDate: "2012-08-11"
category: "backend"
banner: "./method-area-and-runtime-constant-pool/cover.webp"
tags:
  - "Java"
  - "学习笔记"
toc: true
