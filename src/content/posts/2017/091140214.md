...
description: "本文详细介绍了声网（Agora）集成中的关键概念，包括App ID、Dynamic Key、App Certificate、Channel、UID以及信令和通信流程。强调了在安全要求不高的场景下使用App ID，以及在正式上线运营时采用Dynamic Key的重要性。此外，还说明了频道名称（channel）、频道密钥（channel key）的作用，以及如何在同一频道中唯一标识用户（UID）。最后，详细描述了Agora平台上的呼叫建立和发起流程，包括信令服务器与用户的交互、频道的加入和退出，以及在通话中的音视频流控制。"
pubDate: "2017-09-19"
category: "framework"
banner: "./091140214/cover.webp"
tags:
  - "学习笔记"
toc: true
---
