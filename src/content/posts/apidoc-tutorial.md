...
description: "本文介绍了如何使用 @api 标记来生成 API 文档。文章详细讲解了各种标记的功能，包括描述请求方法、路径、错误信息、权限等。同时，还介绍了如何定义全局的 header 描述和使用 apiSampleRequest 来显示接口调用相关部分。"
pubDate: "2017-12-23"
category: "tool"
banner: "./apidoc-tutorial/cover.webp"
tags:
  - "效率工具与工作流"
  - "学习笔记"
toc: true
