...
description: "使用 Nginx Proxy Manager 搭建获取公网 IP 的服务，供 DDNS-GO 使用。"
pubDate: "2023-11-28"
category: "infra"
banner: "./obtain-public-ip-address-using-nginx/cover.webp"
tags:
  - "Linux"
  - "学习笔记"
toc: true
...
![20241229154732_BK2F4R7y.webp](./obtain-public-ip-address-using-nginx/20241229154732_BK2F4R7y.webp)
...
![20241229154732_iGIIYyxR.webp](./obtain-public-ip-address-using-nginx/20241229154732_iGIIYyxR.webp)

> _：泛解析，匹配其他所有域名, 比如配置了 _.aliyun.com, 将匹配: a.aliyun.com, b.aliyun,com

#### 3.1.1 腾讯云

![20241229154732_jJspV63h.webp](./obtain-public-ip-address-using-nginx/20241229154732_jJspV63h.webp)
...
![20241229154732_SAA9DagP.webp](./obtain-public-ip-address-using-nginx/20241229154732_SAA9DagP.webp)
...
![20241229154732_oGR0KeTR.webp](./obtain-public-ip-address-using-nginx/20241229154732_oGR0KeTR.webp)

使用 `https://ip.xxx.info:3200` 进入的流量将被转发到 `192.168.10.10:8000` 所在的服务, 而 **192.168.10.10** 所在的服务器就是 NPM 所在的寄主机(R5S), **8000** 端口需要后续的配置.

#### 3.3.2 R2S-联通

![20241229154732_AfBq8dyJ.webp](./obtain-public-ip-address-using-nginx/20241229154732_AfBq8dyJ.webp)

使用 `https://ip.xxx.cc:3200` 进入的流量将被转发到 `192.168.20.10:8000` 所在的服务, 而 **192.168.20.10** 所在的服务器就是 NPM 所在的寄主机 (R2S), **8000** 端口需要后续的配置.

以上配置完成后, 网络拓扑图如下:

![xxx.drawio.webp](./obtain-public-ip-address-using-nginx/xxx.drawio.webp)
...
![20241229154732_VXHcTW4M.webp](./obtain-public-ip-address-using-nginx/20241229154732_VXHcTW4M.webp)

##### 3.4.2.2 联通

![20241229154732_XtP1vVr9.webp](./obtain-public-ip-address-using-nginx/20241229154732_XtP1vVr9.webp)
...
![yyy.drawio.webp](./obtain-public-ip-address-using-nginx/yyy.drawio.webp)
