...
description: "HomeLab 数据同步方案，使用 Synology Drive 和 Syncthing 实现跨设备文件同步。"
pubDate: "2020-04-20"
category: "homelab"
banner: "./homelab-data-sync/cover.webp"
tags:
  - "Homelab"
  - "学习笔记"
toc: true
...
![syncthing.drawio.webp](./homelab-data-sync/syncthing.drawio.webp)
...
![data-sync.drawio.webp](./homelab-data-sync/data-sync.drawio.webp)
