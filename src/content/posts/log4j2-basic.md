...
description: "Apache Log4j 2 是对 Log4j 的升级，提供了许多改进和修复了 Logback 的一些问题，包括异常处理、性能提升、自动重载配置和无垃圾机制等。文章介绍了 log4j2 的概念、例子、异步日志的使用方法以及注意事项和性能测试结果。"
pubDate: "2014-08-05"
category: "backend"
banner: "./log4j2-basic/cover.webp"
tags:
  - "Java"
  - "日志与监控"
  - "学习笔记"
