...
description: "利用 RAG 技术构建企业知识库 AI 产品，通过向量数据库和 LLM 实现垂直领域的智能问答系统。"
pubDate: "2024-11-06"
category: "ai"
banner: "./rag-introduction/cover.webp"
tags:
  - "数据库"
  - "架构设计"
  - "最佳实践"
...
![AI-应用.drawio.webp](./rag-introduction/AI-应用.drawio.webp)

![dify.drawio.webp](./rag-introduction/dify.drawio.webp)
