...
description: "使用 AI 技术对博客文章进行智能分类，提升内容管理效率和用户体验。"
pubDate: "2025-01-01"
category: "ai"
banner: "./generate-blog-category/cover.webp"
tags:
  - "Hexo"
  - "效率工具与工作流"
  - "最佳实践"
...
在上一篇 [AI助力博客创作：自动生成摘要与标签的实战指南](/posts/generate-blog-tags-using-ai/) 使用的是 Ollama, 但是因为模型的原因生成的结果不是特别满意, 所以这次使用 [LM Studio](https://lmstudio.ai/) 作为服务端为脚本提供 AI 服务, 模型选择的是 [glm-4-9b-chat-1m](https://huggingface.co/bartowski/glm-4-9b-chat-1m-GGUF), 使用的是 **F16** 的版本. 模型有 **18.97GB**, 在 64G 内存的 Macbook Pro Apple M1 Max 跑起来还算流畅, 不得不称赞一下 Apple M 系列的芯片, 只有在跑模型的时候才会烫手, 其他时候都非常安静.
