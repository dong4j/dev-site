---
title: "树莓派集成 PCA9685 舵机控制与流媒体服务器视频推流的综合应用"
description: "在树莓派上集成 PCA9685 舵机控制，结合流媒体服务器实现摄像头角度控制和视频推流。"
pubDate: "2024-11-20"
category: "homelab"
banner: "./raspberry-pi-pca9685/cover.webp"
tags:
  - "Homelab"
  - "自动化运维"
  - "学习笔记"
...
在 [基于树莓派的视频推流方案](/posts/raspberry-pi-stream/) 我们尝试了通过树莓派推流到流媒体服务器, 然后通过 Web 查看视频, 这次我们来尝试一下通过树莓派控制舵机.
...
![20250212192831_nZXdtUU9.webp](./raspberry-pi-pca9685/20250212192831_nZXdtUU9.webp)

**接线方式:**

![20250212211654_e9WCc1VN.webp](./raspberry-pi-pca9685/20250212211654_e9WCc1VN.webp)

**外接供电:**

![20250212211654_iXBUaeEi.webp](./raspberry-pi-pca9685/20250212211654_iXBUaeEi.webp)
...
![20250212192831_8GLVKcak.webp](./raspberry-pi-pca9685/20250212192831_8GLVKcak.webp)
...
![20250212185748_TCP4MjUl.webp](./raspberry-pi-pca9685/20250212185748_TCP4MjUl.webp)

### 嵌入到 Web UI

并排显示 2 个摄像头的画面:

![20250212185909_ILxW2kgL.webp](./raspberry-pi-pca9685/20250212185909_ILxW2kgL.webp)

### 舵机控制

我将舵机连接到了 Zero 2W 上, 然后摄像头与树莓派 5 连接, 所以舵机的控制我需要在 Zero 2W 上处理.

![20250212192838_Js0nHyfm.webp](./raspberry-pi-pca9685/20250212192838_Js0nHyfm.webp)
...
>
> ![20250212191120_4V6TuXsz.webp](./raspberry-pi-pca9685/20250212191120_4V6TuXsz.webp)

## 效果展示

![20250212191238_CRx4L2ui.webp](./raspberry-pi-pca9685/20250212191238_CRx4L2ui.webp)
